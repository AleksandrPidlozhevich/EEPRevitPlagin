    ...
    internal class InstallationDoorWindowLintelsCommand : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            if (windowsAndDoorsList.Count == 0)
            {
                ...
                WindowsAndDoorsSelectionFilter selFilter = new WindowsAndDoorsSelectionFilter();
            ...
            List<Family> lintelFamilysList = new FilteredElementCollector(doc)
                ...
                .OrderBy(f => f.Name, new ComparatorString())
                .ToList();
            ...
            openingParameters = openingParameters.OrderBy(p => p.Definition.Name, new ComparatorString()).ToList();
